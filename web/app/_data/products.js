...
export const PRODUCTS = [
  ...
  },
  {
    ...
    short: "ทาเหล็กสีแดง และ สีเทา น้ำหนัก 25 กก. ทาได้ 60–80 ตร.ม./ถัง",
    cat: "สีรองพื้น/ทับหน้า",
    image: "/images/neocoat-primer.png",
    title: "สีรองพื้นเทา Neocoat Primer Grey Oxide 25 กก. | ราคาโรงงาน",
    description:
      "สีรองพื้นกันสนิม Neocoat Primer Grey Oxide สำหรับทาเหล็กก่อนทาสีกันไฟ มีสีแดงและสีเทา น้ำหนัก 25 กก. ทาได้ 60–80 ตร.ม./ถัง",
  },
  {
  ...
  },
  {
    ...
    short: "ผสมสีทาเหล็ก ขนาดบรรจุ 9 / 15 / 150 กก.",
    cat: "ทินเนอร์/น้ำมันสน",
    image: "/images/thinner-3a-intanin.webp",
    title: "ทินเนอร์ AAA (3A) ผสมสี อินทนิล 9/15/150 กก. | พร้อมส่ง ราคาถูก",
    description:
      "ทินเนอร์ AAA (3A) อินทนิล คุณภาพสูง ขนาดบรรจุ 9 / 15 / 150 กก. ใช้เป็นตัวทำละลายผสมสีสูตรน้ำมัน สีรองพื้น สีทับหน้า และสีชนิดโซลเวนต์",
  },
  {
    slug: "thinner-2k",
    oldId: 21,
